                        ...
                        <div class="w-full max-w-[340px] bg-white rounded-3xl overflow-hidden border border-black/5 shadow-sm hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 group mx-auto">
                            ...
                            <div class="p-8">
                                ...
                                <div class="flex items-center justify-between mt-4">
                                    ...
                                    <a href="https://katalog.beragamsewabali.com" target="_blank"
                                       class="inline-flex items-center gap-2 text-[11px] font-bold uppercase tracking-[0.2em] text-text-primary hover:text-brand-red transition-colors">
