  ...
  return (
    <div className="space-y-4">
      <div className="flex justify-between items-center mb-2">
        <h2 className="text-lg font-bold text-slate-900 dark:text-white flex items-center gap-2">Daftar Aktiva Tetap</h2>
                ...
                <tr key={asset.id} className="hover:bg-slate-50 dark:bg-slate-950/50 transition-colors group">
                  ...
                  <td className="px-5 py-2.5">
                    {isEditing ? (
                      ...
                      <span className="font-medium text-slate-900 dark:text-white">{asset.asset_name}</span>
                    )}
                  </td>
                  <td className="px-5 py-2.5">
                    {isEditing ? (
                  ...
                  <td className="px-5 py-2.5 text-right space-x-2">
                    {isEditing ? (
                      ...
                      <div className="flex justify-end gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                        <button onClick={() => handleEdit(asset)} className="p-1.5 text-slate-400 hover:text-blue-600 dark:text-blue-400 hover:bg-blue-50 dark:bg-blue-500/10 rounded-md transition-colors" title="Edit">
                          <Edit2 className="w-4 h-4" />
                        </button>
                        <button onClick={() => handleDelete(asset.id)} className="p-1.5 text-slate-400 hover:text-rose-600 dark:text-rose-400 hover:bg-rose-50 dark:bg-rose-500/10 rounded-md transition-colors" title="Hapus">
