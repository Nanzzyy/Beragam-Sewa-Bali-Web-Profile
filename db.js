...
const isInternalDb = connectionString.includes('172.17.0.1') || connectionString.includes('localhost') || (process.env.POSTGRES_HOST && !process.env.POSTGRES_HOST.includes('.'));
